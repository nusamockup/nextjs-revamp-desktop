import { createStyles, em, rem, getBreakpointValue, getSize } from '@ns-ui/styles';
...
var useStyles = createStyles((theme, {
  ...
  return {
    root: __spreadProps(__spreadValues(__spreadValues(__spreadProps(__spreadValues(__spreadValues({}, theme.fn.fontStyles()), position), {
      top: layout === "alt" ? 0 : (position == null ? void 0 : position.top) || "var(--ns_ui-header-height)",
      bottom: 0,
      zIndex,
      height: height ? rem(height) : layout === "alt" ? "auto" : "calc(100vh - var(--ns_ui-header-height, 0rem) - var(--ns_ui-footer-height, 0rem))",
