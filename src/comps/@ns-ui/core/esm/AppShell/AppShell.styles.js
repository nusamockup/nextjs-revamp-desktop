import { createStyles, getSize, em, getBreakpointValue } from '@ns-ui/styles';
...
function getPositionStyles(props, theme) {
  ...
  return {
    minHeight: "100vh",
    paddingTop: `calc(var(--ns_ui-header-height, 0px) + ${padding})`,
    paddingBottom: `calc(var(--ns_ui-footer-height, 0px) + ${padding})`,
    paddingLeft: `calc(var(--ns_ui-navbar-width, 0px) + ${padding})`,
    paddingRight: `calc(var(--ns_ui-aside-width, 0px) + ${padding})`,
