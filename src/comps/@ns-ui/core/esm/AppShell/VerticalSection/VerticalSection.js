...
import { getDefaultZIndex, em, rem, Global } from '@ns-ui/styles';
...
const VerticalSection = forwardRef((_a, ref) => {
  ...
  const breakpoints = typeof height === "object" && height !== null ? getSortedBreakpoints(height, theme).reduce((acc, [breakpoint, breakpointSize]) => {
    acc[`@media (min-width: ${em(breakpoint)})`] = {
      [`--ns_ui-${section}-height`]: rem(breakpointSize)
    };
    return acc;
  }, {}) : null;
  return /* @__PURE__ */ React.createElement(Box, __spreadValues({
    ...
    styles: () => ({
      ":root": __spreadValues({
        [`--ns_ui-${section}-height`]: typeof height === "object" ? rem(height == null ? void 0 : height.base) || "100%" : rem(height)
      }, breakpoints)
    })
  }));
});
VerticalSection.displayName = "@ns-ui/core/VerticalSection";
