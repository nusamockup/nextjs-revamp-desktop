...
import { useId, useUncontrolled, useScrollIntoView, useDidUpdate, useMergedRef } from '@ns-ui/hooks';
import { getDefaultZIndex, useComponentDefaultProps } from '@ns-ui/styles';
import { groupOptions } from '@ns-ui/utils';
...
const MultiSelect = forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Input.Wrapper, __spreadValues(__spreadValues({
    ...
    disabled,
    "data-nsui-stop-propagation": dropdownOpened,
    autoComplete: "off",
...
MultiSelect.displayName = "@ns-ui/core/MultiSelect";
