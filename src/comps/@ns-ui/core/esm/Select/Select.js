...
import { useScrollIntoView, useUncontrolled, useDidUpdate, useMergedRef } from '@ns-ui/hooks';
import { getDefaultZIndex } from '@ns-ui/styles';
...
const Select = forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Input.Wrapper, __spreadProps(__spreadValues({}, wrapperProps), {
    ...
    disabled,
    "data-nsui-stop-propagation": shouldShowDropdown,
    name: null,
...
Select.displayName = "@ns-ui/core/Select";
