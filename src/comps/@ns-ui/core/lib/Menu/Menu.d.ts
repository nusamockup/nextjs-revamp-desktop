...
import { ClassNames, Styles } from '@ns-ui/styles';
...
export declare namespace Menu {
    ...
    var Item: (<C = "button">(props: import("@ns-ui/utils").PolymorphicComponentProps<C, import("./MenuItem/MenuItem").MenuItemProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Omit<React.FunctionComponent<(import("./MenuItem/MenuItem").MenuItemProps & {
        component?: any;
