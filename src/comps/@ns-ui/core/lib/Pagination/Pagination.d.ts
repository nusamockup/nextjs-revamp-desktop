...
export declare namespace Pagination {
    ...
    var Next: (<C = "button">(props: import("@ns-ui/utils").PolymorphicComponentProps<C, import("./PaginationEdges/PaginationEdges").PaginationEdgeProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Omit<React.FunctionComponent<(import("./PaginationEdges/PaginationEdges").PaginationEdgeProps & {
        component?: any;
    ...
    var Previous: (<C = "button">(props: import("@ns-ui/utils").PolymorphicComponentProps<C, import("./PaginationEdges/PaginationEdges").PaginationEdgeProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Omit<React.FunctionComponent<(import("./PaginationEdges/PaginationEdges").PaginationEdgeProps & {
        component?: any;
    } & Omit<Pick<any, string | number | symbol>, "component" | keyof import("./PaginationEdges/PaginationEdges").PaginationEdgeProps> & {
        ref?: any;
    }) | (import("./PaginationEdges/PaginationEdges").PaginationEdgeProps & {
    ...
    var Last: (<C = "button">(props: import("@ns-ui/utils").PolymorphicComponentProps<C, import("./PaginationEdges/PaginationEdges").PaginationEdgeProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Omit<React.FunctionComponent<(import("./PaginationEdges/PaginationEdges").PaginationEdgeProps & {
        component?: any;
    } & Omit<Pick<any, string | number | symbol>, "component" | keyof import("./PaginationEdges/PaginationEdges").PaginationEdgeProps> & {
        ref?: any;
    }) | (import("./PaginationEdges/PaginationEdges").PaginationEdgeProps & {
    ...
    var First: (<C = "button">(props: import("@ns-ui/utils").PolymorphicComponentProps<C, import("./PaginationEdges/PaginationEdges").PaginationEdgeProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Omit<React.FunctionComponent<(import("./PaginationEdges/PaginationEdges").PaginationEdgeProps & {
        component?: any;
    } & Omit<Pick<any, string | number | symbol>, "component" | keyof import("./PaginationEdges/PaginationEdges").PaginationEdgeProps> & {
        ref?: any;
    }) | (import("./PaginationEdges/PaginationEdges").PaginationEdgeProps & {
