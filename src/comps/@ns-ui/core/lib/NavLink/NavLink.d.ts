...
import { DefaultProps, NsUIColor, NsUINumberSize, Selectors, Variants } from '@ns-ui/styles';
...
export declare const NavLink: (<C = "button">(props: import("@ns-ui/utils").PolymorphicComponentProps<C, NavLinkProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Omit<React.FunctionComponent<(NavLinkProps & {
    component?: any;
