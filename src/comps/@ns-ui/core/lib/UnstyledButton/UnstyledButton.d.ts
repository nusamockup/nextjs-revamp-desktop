...
export declare const UnstyledButton: (<C = "button">(props: import("@ns-ui/utils").PolymorphicComponentProps<C, UnstyledButtonProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Omit<React.FunctionComponent<(UnstyledButtonProps & {
    component?: any;
