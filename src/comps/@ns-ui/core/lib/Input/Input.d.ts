...
import { DefaultProps, NsUINumberSize, NsUISize, Selectors, Variants } from '@ns-ui/styles';
...
export declare const Input: (<C = "input">(props: import("@ns-ui/utils").PolymorphicComponentProps<C, InputProps>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>) & Omit<React.FunctionComponent<(InputProps & {
    component?: any;
