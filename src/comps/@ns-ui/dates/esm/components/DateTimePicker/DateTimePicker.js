...
import { useComponentDefaultProps, ActionIcon, INPUT_SIZES, CheckIcon } from '@ns-ui/core';
import { useUncontrolled, useDisclosure, useDidUpdate } from '@ns-ui/hooks';
...
const DateTimePicker = forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(PickerInputBase, __spreadValues({
    ...
    size,
    "data-ns-ui-stop-propagation": __stopPropagation || void 0
...
DateTimePicker.displayName = "@ns-ui/dates/DateTimePicker";
