...
import { NsUIColor } from './NsUIColor';
import type { NsUINumberSize, NsUISize } from './NsUISize';
export type SystemProp<Value> = Value | Partial<Record<NsUISize | (string & {}), Value>>;
export type SpacingValue = NsUINumberSize | (string & {});
export interface NsUIStyleSystemProps {
    ...
    bg?: SystemProp<NsUIColor>;
    c?: SystemProp<NsUIColor>;
...
//# sourceMappingURL=NsUIStyleSystem.d.ts.map