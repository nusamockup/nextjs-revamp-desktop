...
import { useNsUITheme, useNsUIProviderStyles, useNsUIEmotionCache } from '../theme/NsUIProvider.js';
...
function createStyles(input) {
  ...
  function useStyles(params, options) {
    ...
    const context = useNsUIProviderStyles(options == null ? void 0 : options.name);
